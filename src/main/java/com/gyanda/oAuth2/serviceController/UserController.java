...
public class UserController {
    ...
    public @ResponseBody String uploadProfilePic(@RequestBody UserProfile profile)
    {
        try
        {
            ...
            String directory= getClass().getResource("/static/images/")+profile.getUserId()+".png"; 
            new FileOutputStream("C://Users//gbajpai//eclipse-workspace//SpringMVC//src//main//resources//static//images/1.png").write(imageByte);
            return "success ";
        	}
        }
        catch(Exception e)
